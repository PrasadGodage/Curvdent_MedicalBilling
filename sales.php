                        ...
                        <!-- <form class="form" id="" method="post"> -->
                            ...
                            <div class="col-6 col-md-3 col-lg-3 col-xs-3 input-group-sm ">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2-selection__rendered" placeholder="Select Item" id="slscustomer" name="">
                            ...
                            <hr>
                            <div class="row">
                                <div class="mb-1 col-6 col-md-2 col-lg-2 col-xs-2 input-group-sm">
                                ...
                                <label class="form-label" style="text-align:right;">Discription</label>
                                    <input type="text" class="form-control" id="txtitemdisc" >
                                    <span id=""></span>
                                </div>
                            ...
                            <!-- <div class="mb-1 col-4 col-md-2 col-lg-2 col-xs-2 input-group-sm" >
                                ...
                                <div class="mb-1 col-4 col-md-1 col-lg-1 col-xs-1 input-group-sm" style="display:none">
                                   ...
                                   <!-- <div class="row">
                                    ...
                                    <!-- <div class="col-2"> -->
                                       <div class="row">
                                            ...
                                            <div class="col-1">
                                                Taxable<input type="text" class="form-control" id="totaltaxableamount" readonly>
                                            </div>
                                            <div class="col-1">
                                            ...
                                            Bill Discount <input type="text" class="form-control" id="BillDiscount" value="0">
                                              ...
                                              <div class="col-2">
                                            Final Bill Total <input type="text" class="form-control form-control-lg" id="FinalBillAmt" readonly> </h3>
                                            </div>
                                       </div>               
                                   <div class="container">
                                        <div class="row mt-1 justify-content-end">
                                           <!-- <h3>Final Tota Bill<input type="text" class="form-control form-control-lg" id="txtfinaldisplayamount" readonly> </h3> -->
                                           <!-- <h3><input type="text" class="form-control form-control-lg" id="txtfinaldisplayamount" readonly> </h3> -->
...
<script>
    ...
    function SaveBill(status)
    {
        ...
        // alert("Bill Details = TempBill NO :"+TEMPBillNo+", BillDate : "+BillDate+", customerid : "+customerid+" Payment Type : "+paymentType);
        ...
        // alert(" TotalItemAmt : "+TotalItemAmt+", TotalDiscAmt : "+TotalDiscAmt+", TotalTaxAbleAmt : "+TotalTaxAbleAmt+", TotalTax : "+TotalTax);
        var RoundOff = $('#roundoff').val();
        var NetBillTotal = $('#NetBillTotal').val();
        var BillCharges = $('#BillCharges').val();
        var ExtraBilldiscount = $('#BillDiscount').val();
        // alert("RoundOff : "+RoundOff+", NetBillTotal : "+NetBillTotal+", BillCharges : "+BillCharges+", ExtraBilldiscount"+ExtraBilldiscount);
        var BillAmountForPaid = $('#FinalBillAmt').val();
        var PaidAmount = $('#PaidAmount').val(); 
        var BalanceAmount = $('#BalanceAmount').val(); 
        // alert("BillAmountForPaid : "+BillAmountForPaid+", PaidAmount : "+PaidAmount+", BalanceAmount : "+BalanceAmount);
...
$("#roundoff").keyup(function(){
        ...
        // var discountamount= $('#NetBillTotal').val();
            if(roundoffvalue!="")
            {
                    ...
                    // $('#txtfinaldisplayamount').val(TotalBillAmount);

            }else
            {
                $('#NetBillTotal').val(Billtotal);
                $('#FinalBillAmt').val(Billtotal);
                // $('#txtfinaldisplayamount').val(TotalBillAmount);
            }
    });
//==========================================================================================
...
<script>
    ...
    function calculateBillAmount()
    {
        ...
        $('#FinalBillAmt').val(TotalBillAmount);
        // $('#txtfinaldisplayamount').val(TotalBillAmount);
